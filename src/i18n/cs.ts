export const cs = {
  ...
  home: {
    ...
    hero_desc: 'Mezinárodní minibasketbalový turnaj pro dívky ve třech věkových kategoriích – U12, U13 a U14. Týmy z různých koutů Evropy se utkají v Hradci Králové o celkové vítězství. Turnaj je pořádán basketbalovým klubem Hradecké lvice.',
    ...
    hero_date_u14: '4. – 6. září 2026',
    hero_date_u12: '11. – 13. září 2026',
  ...
  info: {
    ...
    venues_desc: 'Turnaj probíhá na dvou místech v Hradci Králové: GAPA aréna (U13) a hala Sokol HK (U12, U14). Mezi halami je dobré spojení MHD i možnost parkování.',
