...
import { S as isRemoteAllowed, _ as fetchWithRedirects, b as isRemoteImage, c as isRemotePath, g as inferRemoteSize$1, x as resolveSrc, y as isESMImportedImage } from "./path_BCy-IDfu.mjs";
import { C as unescapeHTML, E as createComponent, T as createAstro, f as renderTemplate, g as maybeRenderHead, t as spreadAttributes, v as addAttribute } from "./server_55xiZ2hy.mjs";
import { a as DEFAULT_HASH_PROPS, i as resolveDefaultOutputFormat, n as isLocalService } from "./service_MfwCF3en.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_DP4kwLjC.mjs").catch((e) => {
