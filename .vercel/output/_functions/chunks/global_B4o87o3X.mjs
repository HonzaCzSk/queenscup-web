...
import { E as createComponent, T as createAstro, _ as renderHead, a as renderComponent, f as renderTemplate, l as renderSlot, n as renderScript, v as addAttribute } from "./server_55xiZ2hy.mjs";
...
var $$Layout = createComponent(async ($$result, $$props, $$slots) => {
	...
	Astro.response.headers.set("Cache-Control", "public, max-age=60, s-maxage=600, stale-while-revalidate=120");
